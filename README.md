React dashboard for visualising scaffolding inspection logs, PPE compliance rates, and site incident trends — built for construction and industrial HSE teams.# hse-compliance-dashboard
